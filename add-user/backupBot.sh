...
Name=$(curl https://raw.githubusercontent.com/RyukillerZ/allow/main/ipvps.conf | grep $MYIP | awk '{print $2}')
...
botbckpBot_menu() {
    ...
    echo -e "\033[0;34m══════════════════════════════════════════════════════\033[0m"
    echo -e "$green VPS Data Backup By PAKYAVPN"
    echo -e "$green Telegram : https://t.me/anakjati567 / @anakjati567"
    echo -e ""
