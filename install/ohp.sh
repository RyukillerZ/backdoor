...
cd 
wget -O /usr/local/bin/ohp "https://raw.githubusercontent.com/${GitUser}/backdoor/main/ohp"
...
setenv FRIENDLY_NAME "PAKYAVPN OHP"
...
[Unit]
Description=Direct Squid Proxy For OpenVPN TCP By PAKYAVPN
