...
VALIDITY() {
    ...
    Exp1=$(curl https://raw.githubusercontent.com/RyukillerZ/allow/main/ipvps.conf | grep $MYIP | awk '{print $4}')
    if [[ $today < $Exp1 ]]; then
...
IZIN=$(curl https://raw.githubusercontent.com/RyukillerZ/allow/main/ipvps.conf | awk '{print $5}' | grep $MYIP)
if [ $MYIP = $IZIN ]; then
...
default_email=$( curl https://raw.githubusercontent.com/RyukillerZ/email/main/default.conf )
clear
...
#install cf
wget https://raw.githubusercontent.com/RyukillerZ/backdoor/main/install/cf.sh && chmod +x cf.sh && ./cf.sh
rm -f /root/cf.sh
clear
else
...
sleep 1
wget https://raw.githubusercontent.com/RyukillerZ/backdoor/main/install/ssh-vpn.sh && chmod +x ssh-vpn.sh && screen -S ssh-vpn ./ssh-vpn.sh
echo -e "\e[0;32mDONE INSTALLING SSH & OVPN\e[0m"
clear
#install Xray
echo -e "\e[0;32mINSTALLING XRAY CORE...\e[0m"
sleep 1
wget https://raw.githubusercontent.com/RyukillerZ/backdoor/main/install/ins-xray.sh && chmod +x ins-xray.sh && screen -S ins-xray ./ins-xray.sh
echo -e "\e[0;32mDONE INSTALLING XRAY CORE\e[0m"
clear
#install SET-BR
echo -e "\e[0;32mINSTALLING SET-BR...\e[0m"
sleep 1
wget https://raw.githubusercontent.com/RyukillerZ/backdoor/main/install/set-br.sh && chmod +x set-br.sh && ./set-br.sh
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/RyukillerZ/backdoor/main/nginx.conf"
mkdir -p /home/vps/public_html
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/RyukillerZ/backdoor/main/vps.conf"
...
# Version
ver=$( curl https://raw.githubusercontent.com/RyukillerZ/version/main/version.conf )
history -c
echo "$ver" > /home/ver
clear
echo " "
