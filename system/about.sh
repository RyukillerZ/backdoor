...
figlet " BY PAKYA" | lolcat
echo -e "\e[32;1m.-----------------------------------------------.\e[0m"
echo -e "\e[32;1m|               \e[36;1mINFO SCRIPT VPS\e[0m                 \e[32;1m|\e[0m"
echo -e "\e[32;1m'-----------------------------------------------'\e[0m"
echo -e "           \e[031;1m> Premium Script By PAKYAVPN <\e[0m" | lolcat
...
echo -e "\e[0;32m|  \e[1;35mFor VPS with KVM and VMWare PakyaVPN         \e[0;32m|\e[0m"
...
echo -e "\e[0;32m|_______________________________________________\e[0;32m|\e[0m"
echo -e "\e[0;32m|                   \e[1;35mPAKYASERVER                 \e[0;32m|\e[0m"
